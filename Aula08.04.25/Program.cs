...
n1 = Convert.ToInt32(ReadLine());
WriteLine("Digite o proximo valor: ");
n2 = Convert.ToInt32(ReadLine());
for (int i = n1; i <= n2; i++)
{
    WriteLine("Número: " + i.ToString());
}
*/
...
string palavraSec;
string palavraDig;
WriteLine("Digite uma palavra secreta: ");
palavraSec = Convert.ToString(ReadLine());
Clear();
WriteLine("Tente acertar a palavra: ");
palavraDig = Convert.ToString(ReadLine());
while (true)
{
    if (palavraSec == palavraDig)
    {
        WriteLine("Palavra Correta!");
        break;
    }
    else if (palavraSec != palavraDig)
    {
        WriteLine("Palavra Incorreta");
        break;
    }
    continue;
}
